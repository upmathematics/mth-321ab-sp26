...
title: | 
  ...
  | Syllabus
subtitle: | 
  | Section A \& B | Spring 2026 | Department of Mathematics | University of Portland
header-includes: |
  \usepackage{fancyhdr}
  \pagestyle{fancy}
...
|  | Th 1/15 | $\rightarrow$ 1st-Order ODEs<br>$\rightarrow$ Equilibriums of 1st-Order ODEs<br>$\rightarrow$ 1st-Order Existence and Uniqueness<br>$\rightarrow$ Slope Fields |
| **2** | Tu 1/20 | $\rightarrow$ Analyzing Equilibriums of 1st-Order ODEs<br>$\rightarrow$ Phase Diagrams<br>$\rightarrow$ Bifurcations in One Dimension |
